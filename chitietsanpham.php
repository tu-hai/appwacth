                                    ...
                                    <div class="page-body">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-sm-6">
                                                        <?php 
                                                            ...
                                                            $sqlprice = "SELECT YEAR(created), MONTH(created) as month, name, address, phone, created
                                                            from hotels WHERE MONTH(created) = $month AND YEAR(created) = $year";                                           
                                        ...
                                        <td>{$row['created']}</td>";
                                                    ...
                                                    <tr >
                                                        ...
                                                        <?php 
                                                            $sqlhotels = "select count(*) as counthotels from hotels
                                                            where month(created) = $month 
                                                            and year(created) = $year";
                                                            $queryhotels = $conn->query($sqlhotels);
                                                            $rowhotels = mysqli_fetch_assoc($queryhotels);
                                                            echo $rowhotels['counthotels'];
                                                         ?>
                                                         </b>
                                                        </td>
                                                    </tr>
